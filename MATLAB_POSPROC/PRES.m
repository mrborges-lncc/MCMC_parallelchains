clear;
base_name = 'prod_D4_KL20_0';
%dados=load('../prod/prodF_ref_0.dat');
dados=load('../SIMULADOR_ELASTICO/exp/pres/pres_ref_0.dat');
ref=dados;
%
...
plot(dados(:,1),dados(:,2),'Parent',axes1,'Color',[1 0 0],...
    'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 1')
plot(dados(:,1),dados(:,3),'Parent',axes1,'Color',[0 0 1],...
    'MarkerSize',4,'Marker','s','LineStyle','none','DisplayName','simul. 2')
plot(dados(:,1),dados(:,4),'Parent',axes1,'Color',[0 0 0],...
    'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 3')
% plot(dados(:,1),dados(:,5),'Parent',axes1,'Color',[0 1 0],...
%     'MarkerSize',4,'Marker','s','LineStyle','none','DisplayName','simul. 4')
% plot(dados(:,1),dados(:,6),'Parent',axes1,'Color',[0 1 1],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 5')
% plot(dados(:,1),dados(:,7),'Parent',axes1,'Color',[0.2 0.2 0.5],...
%     'MarkerSize',4,'Marker','s','LineStyle','none','DisplayName','simul. 6')
% plot(dados(:,1),dados(:,8),'Parent',axes1,'Color',[0 0 0],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 7')
% plot(dados(:,1),dados(:,9),'Parent',axes1,'Color',[1 0 1],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 8')
% plot(dados(:,1),dados(:,10),'Parent',axes1,'Color',[0 1 1],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 9')
% plot(dados(:,1),dados(:,11),'Parent',axes1,'Color',[0 0 0],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 10')
% plot(dados(:,1),dados(:,12),'Parent',axes1,'Color',[1 0 0],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 11')
% plot(dados(:,1),dados(:,13),'Parent',axes1,'Color',[1 1 0],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 12')
% plot(dados(:,1),dados(:,14),'Parent',axes1,'Color',[.8 .8 .8],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 13')
% plot(dados(:,1),dados(:,15),'Parent',axes1,'Color',[0 1 0],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 14')
% plot(dados(:,1),dados(:,16),'Parent',axes1,'Color',[0 1 1],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 15')
% plot(dados(:,1),dados(:,17),'Parent',axes1,'Color',[0 0 1],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 16')
% plot(dados(:,1),dados(:,18),'Parent',axes1,'Color',[0 0 0],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 17')
% plot(dados(:,1),dados(:,19),'Parent',axes1,'Color',[1 0 1],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 18')
% plot(dados(:,1),dados(:,20),'Parent',axes1,'Color',[0 1 1],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 19')
% plot(dados(:,1),dados(:,21),'Parent',axes1,'Color',[0 0 0],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 20')
% plot(dados(:,1),dados(:,22),'Parent',axes1,'Color',[0 1 0],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 21')
% plot(dados(:,1),dados(:,23),'Parent',axes1,'Color',[1 1 0],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 22')
% plot(dados(:,1),dados(:,24),'Parent',axes1,'Color',[1 0 0],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 23')
% plot(dados(:,1),dados(:,25),'Parent',axes1,'Color',[0 0 1],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 24')
% plot(dados(:,1),dados(:,26),'Parent',axes1,'Color',[0 0 1],...
%     'MarkerSize',4,'Marker','o','LineStyle','none','DisplayName','simul. 25')
