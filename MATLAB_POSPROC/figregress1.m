function [L] = figregress1(X1, Y1)
%CREATEFIGURE(X1,Y1)
%  X1:  vector of x data
%  Y1:  vector of y data

%  Auto-generated by MATLAB on 27-Feb-2014 08:52:32

% Create figure
figure1 = figure('PaperType','<custom>','PaperSize',[48.0202844 26.8273999],...
    'PaperUnits','centimeters');

% Create axes
axes1 = axes('Parent',figure1,'Position',[0.1 0.23 0.775 0.815],...
    'FontSize',16);
box(axes1,'on');
hold(axes1,'all');
...
fitResults1(1)
L=(abs(1/(fitResults1(1))));
disp(['comprimento de correlacao estimado:'...
    num2str(L)]);
% Evaluate polynomial
...
% Create textbox
annotation(figure1,'textbox',[0.45 0.92 0.16 0.03881],...
    'String',{'t =0.0e+00'},...
