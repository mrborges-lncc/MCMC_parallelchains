clear;
close all
base_name = 'prod_D1_KLfull_DE_RK1_0';
%dados=load('../prod/prodF_ref_0.dat');
%dados=load('../SIMULADOR_ELASTICO/exp/conc/conc_ref_0.dat');
dados=load('~/MCMC_parallelchains/twophaseflow/exp/pres/pres_referencia_0.dat');
%dados=load('/home/mrborges/MCMC/twophaseflow/exp/prod/prod_ref_0.dat');
ref=dados;
%
file_name = ['~/MCMC_parallelchains/twoStage/select_prod/' base_name '.dat']
file_name = '~/MCMC_parallelchains/twophaseflow/exp/pres/pres_ref_0.dat'
%
% Create figure
figure1 = figure()
B=150.;
