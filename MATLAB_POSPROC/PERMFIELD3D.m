...
% [FILENAME, PATHNAME] =uigetfile('../forecast/FORTRAN_LBD/campos/*.dat', 'LOAD DATA');
...
xslice = [dx,Lx/2,Lx-dx];
yslice = [Ly/2];
zslice = [dz, Lz/8, Lz/4, 3*Lz/8, Lz/2, 5*Lz/8, 3*Lz/4, 7*Lz/8, Lz-dz];
% Create figure
...
% Create colorbar
colorbar('peer',axes1,...
    [0.6 0.35 0.01 0.35],'FontSize',8,...
    'FontName','times','CLim',[-2.5 2.5]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ma=0;
    if(TIPOINPUT==1)
