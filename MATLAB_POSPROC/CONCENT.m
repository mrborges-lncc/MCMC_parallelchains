clear;
base_name = 'prod_D1_KLfull_RW_RK0_64';
%dados=load('../prod/prodF_ref_0.dat');
%dados=load('../SIMULADOR_ELASTICO/exp/conc/conc_ref_0.dat');
dados=load('/home/mrborges/MCMC_par/trunk/simuladorRigido/exp/conc/conc_ref_0.dat');
ref=dados;
%
file_name = ['/home/mrborges/MCMC_par/trunk/twoStage/select_prod/' base_name '.dat']
%
% Create figure
figure1 = figure()
B=0.65;
