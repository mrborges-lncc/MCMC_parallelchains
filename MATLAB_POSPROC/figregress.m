function [L] = figregress(X1, Y1)
%CREATEFIGURE(X1,Y1)
%  X1:  vector of x data
%  Y1:  vector of y data

%  Auto-generated by MATLAB on 25-Feb-2014 11:36:14
...
% Create plot
plot1 = plot(X1,Y1,'Parent',axes1,'DisplayName','data 1');
...
% Plot the fit
fitLine1 = plot(xplot1,yplot1,'DisplayName','   quadratic','Parent',axes1,...
    'Tag','quadratic',...
    'Color',[0 0.75 0.75]);
