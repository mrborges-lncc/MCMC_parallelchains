...
!
  ...
  DO I=1,NPRIORR
     IF(GERATIPO(I).EQ.1.OR.GERATIPO(I).EQ.3.OR.&
          ...
          GERATIPO(I).EQ.15.OR.GERATIPO(I).EQ.10)THEN
        IF(NSINAL.EQ.0)THEN
...
!
     IF(GERATIPO(K).EQ.32.OR.GERATIPO(K).EQ.33.OR.&
          ...
          GERATIPO(K).EQ.15.OR.GERATIPO(K).EQ.10)THEN
...
!     COMMAND=TRIM(COMMAND)// (' env -u OMPI_PATH ./Ex_T2P.sh ')
