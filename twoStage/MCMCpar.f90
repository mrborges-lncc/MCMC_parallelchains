...
!  
  DO I=1,NPRIORR
     ...
     END IF
     IF(GERATIPO(I).EQ.11)THEN
        IF(NK.EQ.0)WRITE(*,*)'<<< GERADOR FORTRAN CAMPOS 3D COND FLUTUACAO >>>'
        FILE_INFIELD(I) = '../gera_KL/FORTRAN_KL3DCOND/in'
     END IF
!
     WRITE(NUMB,'(I4.3)')NK
...
!! DEFINICAO DO SIMULADOR !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  END IF
  IF(NSIMUL.EQ.8)THEN
     IF(NK.EQ.0)WRITE(*,*)'<<< TRACER PROBLEM SIMULATOR >>>'
  END IF
!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!
  ...
  DO I=1,NPRIORR
     IF(GERATIPO(I).EQ.1.OR.GERATIPO(I).EQ.3.OR.&
          ...
          GERATIPO(I).EQ.13.OR.GERATIPO(I).EQ.14.OR.&
          GERATIPO(I).EQ.15.OR.GERATIPO(I).EQ.10.OR.&
          GERATIPO(I).EQ.11)THEN
        IF(NSINAL.EQ.0)THEN
...
!
        ...
        ENDIF
!
        IF(GERATIPO(K).EQ.15)THEN
           CALL GERATHETA(MKL(K),GERATIPO(K),K,NK)
        ENDIF
!
        IF(GERATIPO(K).EQ.10)THEN
           CALL GERATHETA(MKL(K),GERATIPO(K),K,NK)
        ENDIF
!
        IF(GERATIPO(K).EQ.11)THEN
           CALL GERATHETA(MKL(K),GERATIPO(K),K,NK)
        ENDIF
!
     END DO
...
!    IF(TIPO.EQ.0) COMMAND='../gera_LABTRANGEORW3/out/xpsi.dat'
     ...
     END IF
     IF(TIPO.EQ.15)THEN
        COMMAND=('cp -r ../gera_KL/FORTRAN_KL3D_3/in/ ')//&
             (' ../gera_KL/FORTRAN_KL3D_3/in')//TRIM(ADJUSTL(NUMB))//('/')
        WRITE(*,*)COMMAND
        CALL EXECUTE_COMMAND_LINE(COMMAND,WAIT=.TRUE.)
     END IF
     IF(TIPO.EQ.10)THEN
        COMMAND=('cp -r ../gera_KL/FORTRAN_KL3DCOND/in/ ')//&
             (' ../gera_KL/FORTRAN_KL3DCOND/in')//TRIM(ADJUSTL(NUMB))//('/')
        WRITE(*,*)COMMAND
        CALL EXECUTE_COMMAND_LINE(COMMAND,WAIT=.TRUE.)
     END IF
     IF(TIPO.EQ.11)THEN
        COMMAND=('cp -r ../gera_KL/FORTRAN_KL3DFLUT/in/ ')//&
             (' ../gera_KL/FORTRAN_KL3DFLUT/in')//TRIM(ADJUSTL(NUMB))//('/')
        WRITE(*,*)COMMAND
        CALL EXECUTE_COMMAND_LINE(COMMAND,WAIT=.TRUE.)
     END IF
     IF(TIPO.EQ.31)THEN
...
!
     IF(GERATIPO(K).EQ.32.OR.GERATIPO(K).EQ.33.OR.&
          GERATIPO(K).EQ.13.OR.GERATIPO(K).EQ.14.OR.&
          GERATIPO(K).EQ.15.OR.GERATIPO(K).EQ.10.OR.&
          GERATIPO(K).EQ.11)THEN
...
!
     IF(GERATIPO(K).EQ.3.OR.GERATIPO(K).EQ.31&
          ...
          .OR.GERATIPO(K).EQ.13.OR.GERATIPO(K).EQ.14&
          .OR.GERATIPO(K).EQ.15)THEN
        READ(IN_FILE,3000)MMKL
        IF(NK.EQ.0)WRITE(*,2005)MMKL
!
        READ(IN_FILE,7000)FILE_OUT(K)
...
!
        ...
        IF(NK.EQ.0)WRITE(*,7003)FILE_VET(K)
!
        READ(IN_FILE,7000)FILE_MU(K)
        IF(NK.EQ.0)WRITE(*,7005)FILE_MU(K)
!
        READ(IN_FILE,7000)FILE_MM(K)
        IF(NK.EQ.0)WRITE(*,7006)FILE_MM(K)
!
        READ(IN_FILE,7000)FILE_THE(K)
        IF(NK.EQ.0)WRITE(*,7004)FILE_THE(K)
!
...
!
     IF(GERATIPO(K).EQ.11)THEN
        ...
        IF(NK.EQ.0)WRITE(*,2005)MMKL
!
        READ(IN_FILE,7000)FILE_K(K)
        IF(NK.EQ.0)WRITE(*,7100)FILE_K(K)
!
        READ(IN_FILE,7000)FILE_OUT(K)
        IF(NK.EQ.0)WRITE(*,7001)FILE_OUT(K)
!
...
!
     IF(GERATIPO(K).EQ.32.OR.GERATIPO(K).EQ.33.OR.GERATIPO(K).EQ.13&
          .OR.GERATIPO(K).EQ.14.OR.GERATIPO(K).EQ.15&
          .OR.GERATIPO(K).EQ.10.OR.GERATIPO(K).EQ.11)THEN
        DO I=0,NCOND(K)-1
...
7005 FORMAT('NAME OF INPUT MuTilde (Proj)   = ',A)
7006 FORMAT('NAME OF INPUT MMatrix (Proj)   = ',A)
7100 FORMAT('NAME OF INPUT INITIAL FIELD K  = ',A)
8000 FORMAT(2I7)
...
!
  ...
  ENDIF
!
  IF(GERATIPO(K).EQ.32.OR.GERATIPO(K).EQ.13&
       .OR.GERATIPO(K).EQ.14.OR.GERATIPO(K).EQ.15)THEN
     WRITE(IN_FILE,8000)INIF,NFILES
...
!
  IF(GERATIPO(K).EQ.10)THEN
     ...
     WRITE(IN_FILE,7000)ADJUSTL(TRIM(FILE_VAL(K)))
     WRITE(IN_FILE,7000)ADJUSTL(TRIM(FILE_VET(K)))
     WRITE(IN_FILE,7000)ADJUSTL(TRIM(FILE_MU(K)))
     WRITE(IN_FILE,7000)ADJUSTL(TRIM(FILE_MM(K)))
     WRITE(IN_FILE,7000)ADJUSTL(TRIM(FILETHETA))
     WRITE(IN_FILE,1200)NPROPOSAL(K),SIGK
     WRITE(IN_FILE,3000)NCOND(K)
!
...
!
  IF(GERATIPO(K).EQ.11)THEN
     ...
     WRITE(IN_FILE,3000)MKL(K)
     WRITE(IN_FILE,7000)ADJUSTL(TRIM(FILEOUT))
     WRITE(IN_FILE,7000)ADJUSTL(TRIM(FILE_K(K)))
     WRITE(IN_FILE,7000)ADJUSTL(TRIM(FILE_VAL(K)))
     WRITE(IN_FILE,7000)ADJUSTL(TRIM(FILE_VET(K)))
     WRITE(IN_FILE,7000)ADJUSTL(TRIM(FILE_MU(K)))
     WRITE(IN_FILE,7000)ADJUSTL(TRIM(FILE_MM(K)))
...
!
  IF(GERATIPO(K).EQ.15)THEN
     COMMAND=('cd ../gera_KL/FORTRAN_KL3D_3/; sh rodarKL.sh in')//&
          TRIM(ADJUSTL(NUMB))//(' > output_')//TRIM(ADJUSTL(NUMB))//('.out')
  ENDIF
!
  IF(GERATIPO(K).EQ.10)THEN
     COMMAND=('cd ../gera_KL/FORTRAN_KL3DCOND/; sh rodarKL.sh in')//&
          TRIM(ADJUSTL(NUMB))//(' > output_')//TRIM(ADJUSTL(NUMB))//('.out')
  ENDIF
!
  IF(GERATIPO(K).EQ.11)THEN
     COMMAND=('cd ../gera_KL/FORTRAN_KL3DFLUT/; sh rodarKL.sh in')//&
          TRIM(ADJUSTL(NUMB))//(' > output_')//TRIM(ADJUSTL(NUMB))//('.out')
  ENDIF
!
  WRITE(*,*)COMMAND
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  IF(GERATIPO(K).EQ.0.OR.GERATIPO(K).EQ.1.OR.&
       ...
       GERATIPO(K).EQ.14.OR.GERATIPO(K).EQ.15.OR.&
       GERATIPO(K).EQ.10.OR.GERATIPO(K).EQ.11)THEN
!!!!!!!!!!!!!!!! LEITURA DO THETA ANTERIOR !!!!!!!!!!!!!!!!!!!!!!
     ...
     END IF
     IF(GERATIPO(K).EQ.15)THEN
        NOME=ADJUSTL(TRIM('../gera_KL/FORTRAN_KL3D_3/out/theta'))//&
             TRIM(ADJUSTL(NUMB))//TRIM(ADJUSTL('.dat'))
        MK=MKL(K)
     END IF
     IF(GERATIPO(K).EQ.10)THEN
        NOME=ADJUSTL(TRIM('../gera_KL/FORTRAN_KL3DCOND/out/theta'))//&
             TRIM(ADJUSTL(NUMB))//TRIM(ADJUSTL('.dat'))
        MK=MKL(K)
     END IF
     IF(GERATIPO(K).EQ.11)THEN
        NOME=ADJUSTL(TRIM('../gera_KL/FORTRAN_KL3DFLUT/out/theta'))//&
             TRIM(ADJUSTL(NUMB))//TRIM(ADJUSTL('.dat'))
        MK=MKL(K)
     END IF
!
...
!!!!!!!!!!!!!!!! LEITURA DO THETA ATUAL !!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     END IF
     IF(GERATIPO(K).EQ.15)THEN
        NOME=ADJUSTL(TRIM('../gera_KL/FORTRAN_KL3D_3/out/thetanew'))//&
             TRIM(ADJUSTL(NUMB))//TRIM(ADJUSTL('.dat'))
        MK=MKL(K)
     END IF
     IF(GERATIPO(K).EQ.10)THEN
        NOME=ADJUSTL(TRIM('../gera_KL/FORTRAN_KL3DCOND/out/thetanew'))//&
             TRIM(ADJUSTL(NUMB))//TRIM(ADJUSTL('.dat'))
        MK=MKL(K)
     END IF
     IF(GERATIPO(K).EQ.11)THEN
        NOME=ADJUSTL(TRIM('../gera_KL/FORTRAN_KL3DFLUT/out/thetanew'))//&
             TRIM(ADJUSTL(NUMB))//TRIM(ADJUSTL('.dat'))
        MK=MKL(K)
     END IF
!
...
!!!!! ABERTURA DOS ARQUIVOS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  IF(TIPO.EQ.15) FILETHE='../gera_KL/FORTRAN_KL3D_3/out/theta'
  IF(TIPO.EQ.10) FILETHE='../gera_KL/FORTRAN_KL3DCOND/out/theta'
...
!!!!! ABERTURA DOS ARQUIVOS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  IF(TIPO.EQ.15)FILETHE='../gera_KL/FORTRAN_KL3D_3/out/thetanew'
...
!
  IF(NSIMUL.EQ.8)THEN
     COMMAND='cd ./tracer/exp'//TRIM(ADJUSTL(NUMB))//';'
     COMMAND=TRIM(COMMAND)// (' env -i ./Ex_T2P.sh ')
     COMMAND=TRIM(COMMAND)// (' > output_')//TRIM(ADJUSTL(NUMB))//('.out;')
  END IF
!
...
!
  USE VARIAVEIS, ONLY: NSIMUL,ERROSIMULADOR
  CHARACTER*128      :: COMMAND
  INTEGER            :: NFILEV,ISTATV,SERROR,NK,I,J
  CHARACTER(LEN=128) :: FILENV
  CHARACTER(LEN=4)   :: NUMB
!
  WRITE(NUMB,'(I4.3)')NK
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  CALL EXECUTE_COMMAND_LINE(COMMAND,WAIT=.TRUE.,&
       EXITSTAT=I,CMDSTAT=J)
  WRITE(*,*)'EXIT STATUS OF COMMAND',I
  IF(J.EQ.0) THEN
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        IF(GERATIPO(K).EQ.15)THEN
           CHARAUX=TRIM('mv ../gera_KL/FORTRAN_KL3D_3/out/thetanew')//&
                TRIM(ADJUSTL(NUMB))//('.dat ')
           CHARAUX2=TRIM(' ../gera_KL/FORTRAN_KL3D_3/out/theta')//&
                TRIM(ADJUSTL(NUMB))//('.dat')
           COMMAND=TRIM(CHARAUX)//TRIM(CHARAUX2)
           COMMAND=ADJUSTL(TRIM(COMMAND))
!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
           ...
           C=ADJUSTL(C)
!
           CHARAUX =TRIM(' ../gera_KL/FORTRAN_KL3D_3/out/theta')//&
           TRIM(ADJUSTL(NUMB))//('.dat ')
           COMMAND=CHA//CHARAUX
           COMMAND=TRIM(COMMAND)//NAMEOUT
           COMMAND=ADJUSTL(TRIM(COMMAND))
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        IF(GERATIPO(K).EQ.10)THEN
           CHARAUX=TRIM('mv ../gera_KL/FORTRAN_KL3DCOND/out/thetanew')//&
                TRIM(ADJUSTL(NUMB))//('.dat ')
           CHARAUX2=TRIM(' ../gera_KL/FORTRAN_KL3DCOND/out/theta')//&
                TRIM(ADJUSTL(NUMB))//('.dat')
           COMMAND=TRIM(CHARAUX)//TRIM(CHARAUX2)
           COMMAND=ADJUSTL(TRIM(COMMAND))
!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
           ...
           C=ADJUSTL(C)
!
           CHARAUX =TRIM(' ../gera_KL/FORTRAN_KL3DCOND/out/theta')//&
           TRIM(ADJUSTL(NUMB))//('.dat ')
           COMMAND=CHA//CHARAUX
           COMMAND=TRIM(COMMAND)//NAMEOUT
           COMMAND=ADJUSTL(TRIM(COMMAND))
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        IF(GERATIPO(K).EQ.11)THEN
           CHARAUX=TRIM('mv ../gera_KL/FORTRAN_KL3DFLUT/out/thetanew')//&
                TRIM(ADJUSTL(NUMB))//('.dat ')
           CHARAUX2=TRIM(' ../gera_KL/FORTRAN_KL3DFLUT/out/theta')//&
                TRIM(ADJUSTL(NUMB))//('.dat')
           COMMAND=TRIM(CHARAUX)//TRIM(CHARAUX2)
           COMMAND=ADJUSTL(TRIM(COMMAND))
!
...
!
  ...
  END IF
!
  IF(NUMSIMUL.EQ.8)THEN
     WRITE(NUMB,'(I4.3)')NPR
     COMMAND=TRIM('cp -r ../tracer/exp')
     COMMAND=TRIM(COMMAND)//TRIM(' ../tracer/exp') &
          //TRIM(ADJUSTL(NUMB))
     WRITE(*,*)TRIM(COMMAND)
     CALL EXECUTE_COMMAND_LINE(COMMAND,WAIT=.TRUE.)
     IF(NS.EQ.2)THEN
...
!
  IF(NSINCRO.EQ.'N')THEN
     ...
     DO K=1,NPROC
        ...
        CHARAC=TRIM(ADJUSTL(CHARAC))
        FILENAME = TRIM(ADJUSTL('out/vetcont'))//&
             TRIM(ADJUSTL(CHARAC))//TRIM(ADJUSTL('.dat'))
900     CONTINUE
        INQUIRE(FILE=FILENAME, OPENED=I_OPEN,&
             EXIST=I_EXIST, NUMBER=I_NUMBER)
        IF(I_OPEN)THEN
        !        GOTO 900
...
!
  ...
  IF(NSINCRO.EQ.'Y')THEN
     N = 1
     CALL MPI_BARRIER(MPI_COMM_WORLD,IERROR)
     CALL MPI_ALLGATHER(NCONT,N,MPI_INTEGER,VETCONT,N,&
          MPI_INTEGER,MPI_COMM_WORLD,IERR)
     CALL MPI_BARRIER(MPI_COMM_WORLD,IERROR)
  END IF
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!
  DO K=1,NPRIORR
     ...
     IF(GERATIPO(K).EQ.15)THEN
        NOME=ADJUSTL(TRIM('../gera_KL/FORTRAN_KL3D_3/out/theta'))//&
             TRIM(ADJUSTL(NUMB))//TRIM(ADJUSTL('.dat'))
        NAME=ADJUSTL(TRIM('../gera_KL/FORTRAN_KL3D_3/out/theta'))//&
             TRIM(ADJUSTL(NUMA))//TRIM(ADJUSTL('.dat'))
     END IF
     IF(GERATIPO(K).EQ.10)THEN
        NOME=ADJUSTL(TRIM('../gera_KL/FORTRAN_KL3DCOND/out/theta'))//&
             TRIM(ADJUSTL(NUMB))//TRIM(ADJUSTL('.dat'))
        NAME=ADJUSTL(TRIM('../gera_KL/FORTRAN_KL3DCOND/out/theta'))//&
             TRIM(ADJUSTL(NUMA))//TRIM(ADJUSTL('.dat'))
     END IF
     IF(GERATIPO(K).EQ.11)THEN
        NOME=ADJUSTL(TRIM('../gera_KL/FORTRAN_KL3DFLUT/out/theta'))//&
             TRIM(ADJUSTL(NUMB))//TRIM(ADJUSTL('.dat'))
        NAME=ADJUSTL(TRIM('../gera_KL/FORTRAN_KL3DFLUT/out/theta'))//&
             TRIM(ADJUSTL(NUMA))//TRIM(ADJUSTL('.dat'))
     END IF
     IF(GERATIPO(K).EQ.31)THEN
        NOME=ADJUSTL(TRIM('../gera_KL/FORTRAN_RW1/out/theta'))//&
