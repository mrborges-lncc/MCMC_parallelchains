...
G   = computeGeometry(G);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
p_monitores = monitors(G, monitorpres, 'in/input_pres.in');
s_monitores = monitors(G, monitorsat , 'in/input_sat.in');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% GEOLOGIC MODEL %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Read Gaussian fileds %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
filenx = ['./fields/perm_' nome '_'];
fileny = ['./fields/perm_' nome '_'];
filenz = ['./fields/perm_' nome '_'];
fieldnz = 0;
nini = 0;
TOL  = 1.0e-7;
if heter == 1
...
save_data(sol,G,W,getWellSol(W, sol, fluid),salva,nome,0.0,0,0,0,0,...
...
for n=1:nstep
    ...
    save_data(sol,G,W,wellSols{n+1},salva,nome,(t/day),n,njump,ndt,nini,...
        s_monitores,p_monitores,[]);
    waitbar(t/TT,hwb);
end
close(hwb);
