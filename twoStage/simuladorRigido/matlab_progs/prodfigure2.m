...
% Create plot
plot(X1,Y1,'Parent',axes1,'LineWidth',2,'Marker','o','DisplayName','k het.');

% Create plot
plot(X2,Y2,'Parent',axes1,'LineWidth',2,'Marker','+','Color',[1 0 0],'DisplayName','KC');
...
% Create ylabel
ylabel('$v_{_{\, Dn}}$','Interpreter','latex','FontSize',24,...
    'FontName','Times New Roman');
