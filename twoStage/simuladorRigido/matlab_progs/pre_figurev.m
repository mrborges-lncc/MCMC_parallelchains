function pre_figurev(xdata1,ydata1,zdata1,A,B,aa,bb,cc,dd,C,D,t,clim1,clim2)
...
surf(xdata1,ydata1,zdata1);
    ...
    hold off
% Create zlabel
zlabel('p','Visible','off','FontSize',20,'FontName','times');
view(55,20);
%view(135,15);
%view(105,5);
% Create colorbar
if(abs(A-B)<1e-5)
%    colorbar('peer',axes1,[0.95 0.24 0.04216 0.4],'FontSize',14);
else
...
% if(abs(A-B)<1e-8)
%     annotation(figure1,'textbox',[0.4331 0.75 0.1151 0.03881],...
%         'String',{['t =' tempo]},...
