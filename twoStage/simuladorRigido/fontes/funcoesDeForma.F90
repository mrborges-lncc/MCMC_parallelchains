...
!
!****new**********************************************************************
      subroutine newshl(shl,w,npint,nen)
!
...
!              npint = number of integration points, eq. 1, 2, 3 or 4
!
      implicit none
!
...
!
      ...
      integer :: npint, nen
!
      real*8  ::  ra(4), five9, eight9
      real*8  :: r, g, temp, temp1, temp2
      integer :: i, l
...
!***********************************************************************
      subroutine newshg(xl,det,shl,shg,nen,npint,nesd,nel,neg,lnode3)
...
!.... remove above card for single precision operation
!
      real*8  :: xl(nesd,*),det(*),shl(3,nen,npint),shg(3,nen,npint)
      integer :: nen, npint, nesd, nel, neg
      logical ::lnode3
!
      integer :: i, j, l
      real*8  :: x1, x2, temp
