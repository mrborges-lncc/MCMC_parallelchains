function figerro(X1, Y1, mx)
%CREATEFIGURE(X1,Y1)
%  X1:  vector of x data
%  Y1:  vector of y data

%  Auto-generated by MATLAB on 03-Apr-2012 17:06:54
...
% Create plot
plot1=plot(X1,Y1,'Marker','o','LineStyle','none','Color',[0 0 0]);

% Create xlabel
xlabel('$E_{\ c}$','Interpreter','latex','FontSize',14,...
    'FontName','Times New Roman');

% Create ylabel
ylabel('$E_{\ f}$','Interpreter','latex','FontSize',14,...
    'FontName','Times New Roman');
%%%%%%%%% REGRESSAO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[RHO,PVAL]=corr(X1,Y1);
...
% set(legend1,'Position',[0.6572 0.7716 0.1671 0.1079]);
...
elseif isequal(fittype1, 1)
    ...
    op = '+-';
    format1 = ['%s %0.',num2str(digits1),'g*E_c^{%s} %s'];
