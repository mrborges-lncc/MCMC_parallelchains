...
D = max(Y1) * 1.4;
ratio = (B-A)/(D-C);
%  Auto-generated by MATLAB on 30-Nov-2021 07:10:05
...
% Plot the fit
fitLine1 = plot(xplot1,yplot1,'DisplayName','   model','XLimInclude','off',...
    'Tag','linear',...
    'Parent',axes1,...
    'MarkerSize',6,...
...
set(axes1,'DataAspectRatio',[ratio 1 1],'FontName','Times','FontSize',14,...
    'TickDir','both','TickLabelInterpreter','latex',...
    'XMinorTick','on','YMinorTick','on');
% Create legend
legend1 = legend(axes1,'show');
set(legend1,'LineWidth',1,'Interpreter','latex','FontSize',12,...
    'EdgeColor','none',...
    'Color','none');
...
text(.05,.95,txt,'parent',axesh1, 'FontSize',12,...
    'verticalalignment','top','units','normalized','Interpreter','latex');
