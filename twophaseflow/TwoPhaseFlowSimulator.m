...
phi = 0.20;           %% Porosity
K   = [100 100 100] * milli() * darcy();      %% Factor to permeability
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% GRID %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
dx  = Lx/double(nx);
dy  = Ly/double(ny);
...
filephi= [exper '/fields/phi_' nome '_'];
fieldnz = 0;
nini = 0;
TOL  = 1.0e-7;
ckc = 5.10e-12;
...
phirho = 0.20;
phibeta= phi;
[K, phi] = geologia(G,nini,filenx,fileny,filenz,filephi,nD,...
    K,rho,phibeta,phirho,depth,KC,ckc,heter,heterp,printa,nome);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Rock model %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
