function [name_autovet, name_autoval, name_mutilde, ...
    name_MMat] = fnames(homeT,ntipo,beta,eta1,eta2,eta3,...
    Lx,Ly,Lz,NX,NY,NZ,M)

    if ntipo == 1, tipo = 'exp'; end
    if ntipo == 2, tipo = 'frac'; end
    if ntipo == 3, tipo = 'sexp'; end
    if ntipo == 4, tipo = 'matern'; end
    ...
    name_aux = ['_' tipo '_' num2str(ntipo,5) '_'...
