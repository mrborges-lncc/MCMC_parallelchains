function [K] = load_perm(G,namex,namey,namez,depth,nini,nD,tipo_prt,...
    nnx,nny,nnz)
    dp = depth;
    TOL= 1.0e-07;
    ...
    if tipo_prt == 0
        yx = load([namex num2str(nini,'%d') '.dat']);
        yy = load([namey num2str(nini,'%d') '.dat']);
        yz = load([namez num2str(nini,'%d') '.dat']);
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %% Log-permeability %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    K = [yx yy yz];
