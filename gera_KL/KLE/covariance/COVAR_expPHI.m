...
for I=1:1
    ...
    home_fig = '../../RELAT/figuras/';
    home_fig = '/home/mrborges/Congressos/cilamce2011/figuras/';
    home_fig = '/home/mrborges/GEOM_paper/figuras/';
    home = [home1 'g_e*x.dat']
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                bb=num2str(exp(RL(1,2)),'%1.2e');
                if(bb(5)=='e')
                    bb=[bb(1:4) 'e{- \ \ \, ' bb(7:end) '}']
                end
...
%                     y_lim = max_pp*1.25;
                ...
                bb = ['\mathbf{' bb '}'];
                CR = ['\mathbf{' CR '}']; 
                equation1=['$\begin{array}{rcl}\mathcal{\ C}_{Y} (\ {r}\ )\! &=&' bb  Xx '^{^{ \, \frac{- \ \ r}{' aa '}}} \\ R^{\ \! 2} &=& ' CR '\end{array}$'];
...
hold(axes1,'all');
            ...
            legend1 = legend(...
              axes1,{...
              '$\mathbf{computado}$',equation1},...
              'FontName','times',...
              'FontSize',18,...
              'Position',[0.10 0.6152 0.9701 0.1849],...
              'Interpreter','latex');
