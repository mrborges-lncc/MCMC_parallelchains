...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                xx = [0:(l1(2,1)-l1(1,1))*0.1:max(l1(:,1))*2.5]';
...
ylabel(axes1,'$\mathcal{\ C}_{\mathsf{Y}}$','FontSize',24,'Interpreter','latex');
...
set(axes1,'LineWidth',1,'TickDir','both',...
    ...
    'YMinorTick','on');%,'YScale','log');
            ...
            legend1 = legend(...
              ...
              'FontName','times',...
              'FontSize',18,...
              'Position',[0.2 0.68 0.9701 0.1849],...
