...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                ld1 = log(l1(1:alc,:));
                %ld2 = (l1(1:alc,:));
                xx = [min(l1(:,1))*0.5:(l1(2,1)-l1(1,1))*0.1:max(l1(:,1))]';
...
%                     y_lim = max_pp*1.25;
                ...
                bb = ['\mathbf{' bb '}'];
                CR = ['\mathbf{' CR '}'];
                equation1=['$\begin{array}{rcl}{\mathcal{C}_{\phi}}(\ {r}\ )\! &=& ' bb  Xx '^{' aa '} \\ R^{\ 2}\! &=& ' CR '\end{array}$'];
                equation12=['$\ R^{\ \!2} = \ $' CR];
            end
            if I==2
                x2 = dd1(:,1);
...
ylabel(axes1,'$\mathcal{C}_{\phi}$','FontSize',26,'Interpreter','latex');
