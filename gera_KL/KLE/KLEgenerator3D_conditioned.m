...
if(inputbox==1)
    ...
    file_input_cond = './in/input_cond.dat';
...
[tipo,lb] = loglambdafig([1:num_elem],lambda,M,home_fig,nx,ny,nz,eta1,eta2,eta3,...
    beta,nu,ntipo);
name = [tipo '_' num2str(NX,5) 'x' num2str(NY,5) 'x'...
...
[name_autovet, name_autoval, name_mutilde, name_MMat] = ...
    fnames(homeT,ntipo,beta,eta1,eta2,eta3,Lx,Ly,Lz,NX,NY,NZ,M);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
