function sat_figure_contour(xdata1,ydata1,zdata1,A,B,aa,bb,cc,dd,C,D,t,clim1,clim2)
...
contour(xdata1,ydata1,zdata1,8,...
    'Parent',axes1,'LineWidth',1.5);%,'ShowText','on');
% Create zlabel
zlabel('MB','Visible','off','FontSize',20,'FontName','times');
view(1.e-1,90.0+1e-1)
% Create colorbar
if(abs(A-B)<1e-5)
