...
FILENAME='sat_teste.res'
line_file=['../out/' FILENAME]
%
...
cl1=-1.0;      % minimo valor no colormap
...
for i=1:length(time);
    ...
    num=num2str(i-1);
    if(contorno==0)
        sat_figureOCTAVE(xpos,ypos,satmat(:,:,i),A,B,aa,bb,cc,dd,C,D,t,cl1,cl2);
        base_aux = ['_sat-' num];
        base=[base_name base_aux '.eps']
