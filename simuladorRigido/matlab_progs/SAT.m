...
[FILENAME, PATHNAME] = uigetfile('../exp/out/s*.res', 'LOAD DATA');
%[FILENAME, PATHNAME] = uigetfile('/media/mrborges/HD-E1/ALTIX_I/KL20/simuladorBTMM/exp01/out/s*.res', 'LOAD DATA');
...
cl2=1.0;      % maximo valor no color&map
