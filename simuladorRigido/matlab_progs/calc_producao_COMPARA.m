...
[FILENAME, PATHNAME] = uigetfile('../prod/prod_teste*.dat', 'LOAD DATA');
...
%ref ='../prod/prod_eahetKC_Nrand90.dat';
ref ='../prod/prod_teste_0.dat';
hom = load(ref);
...
prodfigure3(t, y, hom(:,1), hom(:,2))%grid on
sinal=0;
for i=size(name_base,2):-1:1
    str=name_base(i);
    if(str=='/')
