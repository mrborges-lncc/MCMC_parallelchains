function fivespot(Lx,Ly,Lz,nx,ny,nz,q,nome)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
hx = Lx/double(nx);
hy = Ly/double(ny);
hz = Lz/double(nz);
...
for i=1:nz-1
   fprintf(fid,'%10d%10d%10d%10d\n',...
       i*nx*ny+n2+((nx+1)*ny+(ny+1)*nx)*i,...
       i*nx*ny+n2+((nx+1)*ny+(ny+1)*nx)*i,1,0);
end
n1 = nx*ny+2*nx+1;
n2 = (n1)+(2*nx+1)*(ny-1);
for i=1:nz
   fprintf(fid,'%10d%10d%10d%10d\n',...
       n2+((nx+1)*ny+(ny+1)*nx)*(i-1)+(i-1)*nx*ny,...
       n2+((nx+1)*ny+(ny+1)*nx)*(i-1)+(i-1)*nx*ny,1,0);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1:nz
    fprintf(fid,'%10d%10d%10.2e\n%30.2e\n%10d%10d\n',...
        n1+((nx+1)*ny+(ny+1)*nx)*(i-1)+(i-1)*nx*ny,2,q,q,0,1);
end
n1 = nx*ny+1;
n2 = nx*ny+nx;
fprintf(fid,'%10d%10d%10.2e\n%30.2e\n%10d%10d\n',n1,2,q,q,0,1);
for i=1:nz-1
    fprintf(fid,'%10d%10d%10.2e\n%30.2e\n%10d%10d\n',...
        i*nx*ny+n1+((nx+1)*ny+(ny+1)*nx)*i,2,q,q,0,1);
end
%%% face injecao valores %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fprintf(fid,'%10d\n',0);
fprintf(fid,'%10d%10d%10d%10d%10d\n',1,1,8,8,0);
